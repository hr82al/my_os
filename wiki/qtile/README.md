...
5. [🗺️ Roadmap XFCE4 → qtile](roadmap.md) — фазированный план привыкания (дни/недели/месяц)
6. [📋 Decisions & Q&A](decisions.md) — почему qtile, а не i3/sway/KDE
...
├── roadmap.md         Фазированный план перехода с XFCE/DE на qtile
└── decisions.md       Q&A
```
